    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img class="img-fluid" src="{{asset('/images/Main-Design-file-illustrator-2023-222.png')}}" alt="" width="96px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="header01">
                <ul class="navbar-nav ms-auto mt-3 mt-lg-0 mb-3 mb-lg-0 me-4">
                    <li class="nav-item me-4"><a class="nav-link" href="https://smsunlight.com/" target="_blank">About</a></li>
                    <!-- <li class="nav-item me-4"><a class="nav-link" href="#">Company</a></li> -->
                    <li class="nav-item me-4"><a class="nav-link" href="https://smsunlight.com/services/" target="_blank">Services</a></li>
        ...
        <section>
    <!-- Other content or section elements -->
            <div style="text-align: center; padding: 50px;">
            <img src="/images/Main-Design-file-illustrator-2023-222.png" alt="Image" style="width: 500px; height: auto;">
            </div>

            <div><p style="font-size: 50px; font-weight: bold; color:black; padding-bottom: 100px; text-align: center;">*** SM Sunlight Group ***</p></div>

            <div>
            <marquee behavior="scroll" direction="5" style="font-size: 50px; font-weight: bold; color:green; padding-bottom: 100px">Our Showrooms: Mayer Doya Battery & IPS | Sunlight Battery & IPS | Sunlight Battery House</marquee>
            </div>
        ...
        <footer class="py-5 bg-light">
            <div class="container text-center pb-5 border-bottom">
                ...
                <ul class="d-flex flex-wrap justify-content-center align-items-center list-unstyled mb-4">
                    <li><a class="link-secondary me-4" href="https://smsunlight.com/about-us/" target="_blank">About</a></li>
                    <li><a class="link-secondary me-4" href="https://smsunlight.com/services/" target="_blank">Services</a></li>
                    <li><a class="link-secondary"  href="https://smsunlight.com/team/" target="_blank">Team</a></li>
                </ul>
                <div>
                    <a class="d-inline-block me-4" href="https://www.facebook.com/smsunlightgroup" target="_blank">
                        <img src="{{asset('/images/facebook.svg')}}">
                    </a>
                    <a class="d-inline-block me-4" href="https://twitter.com/smsunlightgroup" target="_blank">
                        <img src="{{asset('/images/twitter.svg')}}">
                    </a>
                    <a class="d-inline-block me-4" href="https://www.instagram.com/sm_sunlight_group/" target="_blank">
                        <img src="{{asset('/images/instagram.svg')}}">
                    </a>
                    <a class="d-inline-block" href="https://www.linkedin.com/company/smsunlightgroup/?viewAsMember=true" target="_blank">
            ...
            <div class="mb-5"></div>
            <div class="container">
                <p class="text-center">All rights reserved © SM Sunlight Group 2007-2024</p>
            </div>
        </footer>
